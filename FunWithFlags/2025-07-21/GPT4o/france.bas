...
40 LINE (0, 0)-(213, 399), 1, BF  ' Draw the blue part of the flag
...
90 PRINT "French Flag"
100 PLAY "T120 O4 L8 C E G G F E D C D E F G A G F E D C"  ' Play a more accurate version of the French anthem
110 END
